...
window.addEventListener('beforeunload', function (e) {
    ...
    const isExternalLink = !window.location.hostname.includes('your-website.com'); // Replace 'your-website.com' with your domain
  
    if (isExternalLink) {
      // If they are navigating to a different domain, show the confirmation
      const message = "You are about to leave this site. Are you sure you want to leave?";
      e.returnValue = message; // Most modern browsers
