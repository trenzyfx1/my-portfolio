...
document.addEventListener("DOMContentLoaded", function() {
    // Show the auto-open message when the page loads
    setTimeout(function() {
        document.getElementById('auto-open-message').style.display = 'block';
    }, 3000); // Message appears 3 seconds after page load

    // Hide the auto-open message when the user starts scrolling
    window.addEventListener('scroll', function() {
        document.getElementById('auto-open-message').style.display = 'none';
    });

    // Show the chatbot when the user clicks the auto-open message
    document.getElementById('auto-open-message').addEventListener('click', function() {
        ...
        document.getElementById('auto-open-message').style.display = 'none'; // Hide the auto message once clicked
    });

    // Open the chat when the user clicks the chat toggle button
    document.querySelector('.chat-toggle').addEventListener('click', function() {
        document.querySelector('.chatbot').style.display = 'block';
        document.getElementById('auto-open-message').style.display = 'none'; // Hide auto-open message if toggle is clicked
    });
