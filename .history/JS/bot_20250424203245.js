...
document.addEventListener("DOMContentLoaded", function() {
    // Show the auto-open message after 3 seconds
    setTimeout(function() {
        document.getElementById('auto-open-message').style.display = 'block';
    }, 3000);

    // Close auto-open message on scroll
    window.addEventListener('scroll', function() {
        var autoMessage = document.getElementById('auto-open-message');
        if (autoMessage.style.display === 'block') {
